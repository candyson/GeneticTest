...
import geneticsResources.*;

public class Breeder {

	private static double defaultMutationRate = Constants_Main.defaultMutationRate;
	private static double defaultGeneParentARate = Constants_Main.defaultGeneParentARate;
